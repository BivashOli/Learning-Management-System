...
<div class="header">
      ...
      <div class="create">
    <a href="create-assignment.html" target='_blank' >Create Assignment</a>
    <a href = "grades-teacher.php">Students</a>
</div>
    <?php
...
foreach ($assignments as $a){
    ...
    echo "<div class='box'>
    <a href='assignment-teacher.php?class_code=$class&aid=$aid'>
    <div class='title'>
    ...
    echo "<div class='an'><a href='class-boolean.php'>
    Assignment
    </a>
    </div>";
